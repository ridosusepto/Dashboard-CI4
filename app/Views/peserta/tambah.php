                        ...
                        <form action="/peserta/save" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" <?= ($validation->hasError('peserta_nip')) ? 'class="is-invalid"' : ''; ?> id="peserta_nip" name="peserta_nip" autofocus value="<?= old('peserta_nip'); ?>" class="form-control" placeholder="NIP" aria-label="ACME Inc." aria-describedby="peserta_nip" />
                                </div>
                                <div class="invalid-feedback">
                                    <?= $validation->getError('peserta_nip'); ?>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if (\Config\Services::validation()->hasError('peserta_nama')) : ?>
                                    <div class="invalid-feedback">
                                        <?= \Config\Services::validation()->getError('peserta_nama') ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="mb-3">
                                ...
                                <?php if (\Config\Services::validation()->hasError('peserta_email')) : ?>
                                    <div class="invalid-feedback">
                                        <?= \Config\Services::validation()->getError('peserta_email') ?>
                                    </div>
                                <?php endif; ?>
